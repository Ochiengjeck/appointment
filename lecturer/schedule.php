            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  schedule where lecid=$userid;");
                ...
                $sqlmain= "select schedule.scheduleid,schedule.title,lecturer.lecname,schedule.scheduledate,schedule.scheduletime,schedule.nop from schedule inner join lecturer on schedule.lecid=lecturer.lecid where lecturer.lecid=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
